...
({									\
	pr_info("[ILITEK_V3:info]: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\

#define ILI_ERR(fmt, arg...)						\
({									\
	pr_err("[ILITEK_V3:ERR]: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\
...
do {									\
	if (debug_en)						\
	pr_info("[ILITEK_V3:Debug]: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
} while (0)
