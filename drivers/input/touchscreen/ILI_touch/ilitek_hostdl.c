...
/* HMD code for DRSTRANGE-781 by zhouzichun at 2020/07/27 start */
			if(dma==0x83) {
				ipio_err("dma = 0x83,is out ice mode,return!\n");
				return -EFW_CRC;
			}
/* HMD code for DRSTRANGE-781 by zhouzichun at 2020/07/27 end */
			if (mode != GESTURE) {
