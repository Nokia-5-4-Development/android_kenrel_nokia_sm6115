...
/* HMD modify for HS70-147 by zhouzichun  start */
extern struct platform_device hwinfo_device;
int ili_test_node_exit(struct platform_device *tpinfo_device);
/* HMD modify for HS70-147 by zhouzichun  end */
#define Driver_Data             "2020/09/14"
/* Options */
...
/* HMD modify for HS70-326 by liufurong  start */
#define ENABLE_WQ_ESD			DISABLE
/* HMD modify for HS70-326 by liufurong  end */
#define ENABLE_WQ_BAT			DISABLE
#define ENABLE_GESTURE			ENABLE
#define REGULATOR_POWER			DISABLE
#define TP_SUSPEND_PRIO			ENABLE
/* Huaqin modify for DRSTRANGE-48 by gaozehngwei at 2020/06/03 start*/
#define RESUME_BY_DDI			ENABLE
/* Huaqin modify for DRSTRANGE-48 by gaozehngwei at 2020/06/03 end*/
...
/* Huaqin add for HMD by zhouzichun at 2020/08/06 start */
#define KEY_GESTURE_POWER				KEY_WAKEUP
/* Huaqin add for HMD by zhouzichun at 2020/08/06 end */
...
/* HMD add for SR-ZQL1871-01-177 by gaozhengwei at 2019/11/02 start */
extern int ilitek_lcm_bias_power_init(struct ilitek_tddi_dev *data);
extern int ilitek_lcm_bias_power_deinit(struct ilitek_tddi_dev *data);
extern int ilitek_lcm_power_source_ctrl(struct ilitek_tddi_dev *data, int enable);
/* HMD add for SR-ZQL1871-01-177 by gaozhengwei at 2019/11/02 end */
