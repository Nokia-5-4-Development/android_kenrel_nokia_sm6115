...
static int fts_fwupg_get_module_info(struct fts_upgrade *upg)
{
    ...
    if (NULL != strstr(fts_data->pdata->panel_name, "mdss_dsi_ft8615ab_gx_hd_video")) {
        upg->module_id = 0x40;
        strcpy(fts_data->pdata->module_name,"ft8615_GX");
        FTS_INFO("the specified display module is GX-BOE\n");
    }
    else if(NULL != strstr(fts_data->pdata->panel_name, "mdss_dsi_ft8615ab_gx_sbl_hd_video")) {
        upg->module_id = 0xB1;
        strcpy(fts_data->pdata->module_name,"ft8615_gx_sbl");
        FTS_INFO("the specified display module is ft8615_gx_sbl\n");
    }
    ...
    /*HS70 code for HLT-CDH bringup by zhouzichun at 2020/3/20 end*/
        ...
        upg->module_id = 0x10;
        strcpy(fts_data->pdata->module_name,"ft8615_GX");
        FTS_ERROR("can't find the specified display module .default to GX-BOE\n");
    }
